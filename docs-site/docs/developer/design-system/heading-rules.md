...
見出しは、画面内の情報構造と視線誘導をそろえるための基準です。文言だけでなく、役割ごとに意味階層を固定し、見た目はタイポグラフィと余白で調整します。
...
- ページ先頭の主題: `Heading level="page" appearance="hero"`。ラインなし、大きい文字と説明文で主役感を出す
- ページ内の主要ブロック: `Heading level="section" appearance="standard"`。ラインなしで本文より一段強いタイポを使う
...
- ページや主要セクション向けの強い見出しトーンをカードの小見出しや一覧の補助ラベルに流用する
