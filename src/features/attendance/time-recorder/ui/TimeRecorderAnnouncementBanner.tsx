    ...
    <div className="sticky top-0 z-40 px-3 pt-3 md:px-4 md:pt-4">
      ...
      >
        ...
        <button
          ...
          className="inline-flex h-7 w-7 items-center justify-center rounded-full border border-cyan-300 bg-white text-cyan-700 transition hover:border-cyan-400 hover:text-cyan-900"
        >
