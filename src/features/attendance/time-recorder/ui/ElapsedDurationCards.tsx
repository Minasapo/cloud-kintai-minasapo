    ...
    >
      ...
      >
        <div className="flex items-start justify-between gap-3">
          ...
          <InfoIconTooltip
            testId="register-dashboard-current-work-info"
            ariaLabel="休憩時間を差し引いた勤務時間を表示します"
            tooltipContent="休憩時間を差し引いた勤務時間を表示します"
          />
        </div>
      ...
      >
        <div className="flex items-start justify-between gap-3">
          ...
          <InfoIconTooltip
            testId="register-dashboard-current-rest-info"
            ariaLabel="休憩中のみカウントします"
            tooltipContent="休憩中のみカウントします"
          />
        </div>
        <div className="mt-2 flex items-end justify-end">
          <p className="m-0 shrink-0 text-3xl font-extrabold leading-none tracking-[-0.03em] text-slate-950">
