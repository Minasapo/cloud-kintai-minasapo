...
export default function SyncCognitoUser({
  ...
  return (
    <button
      ...
      className="inline-flex h-9 items-center gap-1.5 rounded-xl border border-emerald-700/15 bg-white/90 px-4 text-xs font-semibold tracking-wide text-emerald-800 transition hover:border-emerald-300 hover:bg-emerald-50 disabled:cursor-not-allowed disabled:opacity-70"
      onClick={() => {
