    ...
    <div className="flex flex-col gap-10">
      <div className="flex flex-col gap-6">
        ...
        <div className="flex flex-row justify-between pt-2">
          <button
            className="flex flex-row items-center gap-2 rounded-lg border border-slate-300 px-4 py-2 text-slate-700 transition hover:bg-slate-50 disabled:opacity-50"
            onClick={handleReset}
            disabled={saving}
            type="button"
          >
