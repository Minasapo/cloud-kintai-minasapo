...
export default function WorkflowCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setApprovedStaffIds(initialValues.approvedStaffIds);
    setCurrentApprovedStaffIdsValue("");
    setRejectedStaffIds(initialValues.rejectedStaffIds);
    setCurrentRejectedStaffIdsValue("");
    setFinalDecisionTimestamp(initialValues.finalDecisionTimestamp);
    setCategory(initialValues.category);
    setCustomWorkflowTitle(initialValues.customWorkflowTitle);
    setCustomWorkflowContent(initialValues.customWorkflowContent);
    setStaffId(initialValues.staffId);
    setStatus(initialValues.status);
    setAssignedApproverStaffIds(initialValues.assignedApproverStaffIds);
    setCurrentAssignedApproverStaffIdsValue("");
    setNextApprovalStepIndex(initialValues.nextApprovalStepIndex);
    setSubmitterApproverSetting(initialValues.submitterApproverSetting);
    setSubmitterApproverId(initialValues.submitterApproverId);
    setSubmitterApproverIds(initialValues.submitterApproverIds);
    setCurrentSubmitterApproverIdsValue("");
    setSubmitterApproverMultipleMode(
      initialValues.submitterApproverMultipleMode
    );
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "WorkflowCreateForm")}
      {...rest}
    >
      <ArrayField
