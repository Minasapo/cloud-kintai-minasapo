...
const StaffIcon = ({ name }: StaffIconProps) => {
  return (
    <Link
      aria-label="account"
      to="/profile"
      className="inline-flex rounded-full p-[2px] transition hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500 focus-visible:ring-offset-2 sm:p-[6px]"
    >
