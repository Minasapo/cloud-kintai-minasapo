...
export default function AdminSummaryCard({
  ...
  const linkClassName = isDashboardVariant
    ? "block h-full rounded-[4px] no-underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400/70 hover:no-underline"
    : `group block rounded-[4px] no-underline transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-400/70 hover:no-underline ${className ?? ""}`;
  const sectionClassName = isDashboardVariant
    ? "relative flex h-full min-h-[140px] flex-col rounded-[4px] border-[1.5px] border-solid border-[rgba(148,163,184,0.42)] bg-white px-3 py-3 md:px-4 md:py-[10px] shadow-[0_14px_28px_-24px_rgba(15,23,42,0.45)]"
    : `relative rounded-[4px] border-[1.5px] border-solid border-[rgba(148,163,184,0.42)] bg-white px-4 shadow-[0_14px_28px_-24px_rgba(15,23,42,0.45)] transition group-hover:border-[rgba(148,163,184,0.55)] group-hover:shadow-[0_18px_32px_-22px_rgba(15,23,42,0.5)] ${compact ? "pt-2.5 pb-1.5" : "h-full pt-3 pb-2"} ${className ?? ""}`;
  ...
  const adminOnlyTagClassName = isDashboardVariant
    ? "inline-flex items-center rounded-[4px] border border-solid border-slate-300 bg-white px-2.5 py-1 text-[11px] font-semibold leading-none tracking-[0.01em] text-slate-700"
    : "absolute left-1 top-1 inline-flex items-center rounded-[4px] border border-solid border-slate-300 bg-white px-2.5 py-1 text-[11px] font-semibold leading-none tracking-[0.01em] text-slate-700";
      ...
      <section className={sectionClassName}>
        ...
        <div className={contentClassName}>
          <div className={titleWrapperClassName}>
            ...
            <SubsectionTitle className={titleClassName}>{title}</SubsectionTitle>
          </div>
