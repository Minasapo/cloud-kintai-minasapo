          ...
          value={
            {
              ...
              // The extension manifest reads its enabled state from
              // `derived.attendanceStatisticsEnabled`; surface the same value
              // here so the menu reflects the toggled flag.
              derived: { attendanceStatisticsEnabled },
            } as never
          }
        >
          <NavigationMenu />
